...
$(document).ready(function () {
    ...
    // Анимация корзины при изменении количества товаров
    function animateCart() {
        const cartIcon = $("#goods-in-cart-count");
        cartIcon.addClass("cart-animate");
        setTimeout(() => cartIcon.removeClass("cart-animate"), 300);
    }

    // Универсальная функция AJAX для корзины
    function sendCartAjax(url, data, change = 0) {
        $.ajax({
            type: "POST",
            url: url,
            data: data,
            ...
            error: function () {
                console.log("Ошибка при работе с корзиной");
            },
        });
    }
    ...
    // Формат номера телефона (xxx) xxx-xxxx
